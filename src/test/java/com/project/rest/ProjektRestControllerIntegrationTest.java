...
public class ProjektRestControllerIntegrationTest {
    ...
    private static final Logger logger = LoggerFactory.getLogger(ProjektRestControllerIntegrationTest.class);
...
// WCZEŚNIEJ NA ICH NAZWĘ
    ...
    public void getProjectsAndVerifyPagingParams() throws Exception {
        ...
        assertEquals(size, pageable.getPageSize());assertEquals(sortProperty, pageable.getSort().getOrderFor(sortProperty).getProperty());
